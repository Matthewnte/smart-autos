  ...
  return (
    <Grid container className={classes.root}>
      ...
      <Grid item xs={12} sm={7}>
        ...
        <Typography variant="subtitle1" className={clsx(classes.inputTitle, classes.marginTop)}>
        ...
        <TextField
          ...
          fullWidth
        />
        <FormControl variant="outlined" className={clsx(classes.formControl, classes.marginTop)}>
          <InputLabel className={classes.selectLabel}>Category</InputLabel>
          <Select style={{ height: 48 }} value={category} onChange={handleChange} label="Category">
            ...
            <MenuItem value="scienceAndTechnology">Science and technology</MenuItem>
        ...
        <Typography variant="body2" className={`${!isTagFocus && classes.hide}`}>
          Improve discoverability of your event by adding tags relevant to the subject matter.
        </Typography>

        {/* Date and time */}
        <>
          <Typography variant="subtitle1" component="h3" className={classes.marginTop}>
            Date and time
          </Typography>
          <Typography variant="subtitle1" component="p" style={{ marginTop: 4 }}>
